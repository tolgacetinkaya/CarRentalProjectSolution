...
namespace ConsoleUI
{
    class Program
    {
        ...
        private static void AddRental()
        {
            ...
            var rental1 = rentalManager.Add(new Rental { CarId = 1, CustomerId = 2, RentDate = new DateTime(2021, 1, 20) });
            var rental2 = rentalManager.Add(new Rental { CarId = 4, CustomerId = 1, RentDate = new DateTime(2021, 2, 10) });
            var rental3 = rentalManager.Add(new Rental { CarId = 1, CustomerId = 3, RentDate = DateTime.Today });
